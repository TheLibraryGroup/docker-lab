...
[[ $1 == "root" ]] && echo "Bad usage : ./install_docker.sh [user] (works with debian ubuntu and raspbian)" && exit 1
...
install_componant(){
	...
	apt install -y apt-transport-https ca-certificates curl gnupg-agent software-properties-common lsb-release dirmngr
